...
The \msrcode{init} operation has the following properties:
	...
	\adddoublerow{init}{
	used to initialize the current object as a new instance of the ctInjury type. }

	\addrowheading{Parameters}
	\addnumbereddoublerow{}{Aid: dtInjuryID}{} 
	...
	\addnumberedsinglerow{PostF}{true if the system poststate includes the current object as a new ctInjury instance having its attributes equal to the ones provided as parameters. }
