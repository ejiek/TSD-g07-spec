...
The \msrcode{isSentToCoordinator} operation has the following properties:
	...
	\adddoublerow{isSentToCoordinator}{used to provide a given coordinator with current injury information.}
	...
	\addnumberedsinglerow{PostF}{true if the message ieSendAInjury is sent by the simulator to the input interface of the given coordinator actor with the current injury as parameter value.}
	...
	\vspace{1cm}
	The listing~\ref{OM-ctInjury-isSentToCoordinator-PROLOG-LST} provides the \msrmessir (Prolog-oriented) implementation of the operation.
