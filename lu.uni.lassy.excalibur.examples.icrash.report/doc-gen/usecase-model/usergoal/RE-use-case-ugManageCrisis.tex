...
\addnumberedsinglerow{}{\msrucname{oeAddVictim [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeDeleteVictim [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeAddInjury [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeDeleteInjury [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeAddVictim} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeDeleteVictim} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeAddInjury} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeDeleteInjury} use case}
