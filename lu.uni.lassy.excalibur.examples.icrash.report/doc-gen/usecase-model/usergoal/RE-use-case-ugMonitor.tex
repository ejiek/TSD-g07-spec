...
the actCoordinator's goal is to get the detailed list of existing crisis, alerts, victims and injuries to decide on next actions to undertake. 
...
\addnumberedsinglerow{}{\msrucname{oeGetVictimSet [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeGetInjurySet [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeGetVictimSet} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeGetInjurySet} use case}
