...
\adddoublerow{ctHospital}{used to model system's representation about the actors that have the responsibility to monitor crisis and related victims with injuries.}
\addsingletwocolumnrow{extends}{icrash.concepts.primarytypes.classes.ctAuthenticated}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtHospitalID}}{a unique identification information.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtHospitalID, Alogin:dtLogin, Apwd:dtPassword):ptBoolean}}{used to initialize the current object as a new instance of the ctHospital type.}
...
\adddoublerow{ctInjury}{Used to model injury victim gets in a crisis}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtInjuryID}}{the injury unique identification information.}
\adddoubletwocolumnrow{attribute}{\msrcode{kind: etInjuryKind}}{the type of injury describes body part}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtInjuryID, AetInjuryKind:etInjuryKind):ptBoolean}}{used to initialize the current object as a new instance of the ctInjury type.}
\adddoubletwocolumnrow{operation}{\msrcode{isSentToCoordinator(AactCoordinator:actCoordinator):ptBoolean}}{used to provide a given coordinator with current injury information.}
\adddoubletwocolumnrow{operation}{\msrcode{isSentToHospital(AactHospital:actHospital):ptBoolean}}{used to provide a given hospital with current injury information.}
...
\adddoubletwocolumnrow{operation}{\msrcode{init(AnextValueForAlertID:dtInteger, AnextValueForCrisisID:dtInteger, AnextValueForVictimID:dtInteger, AnextValueForInjuryID:dtInteger, Aclock:dtDateAndTime, AcrisisReminderPeriod:dtSecond, AmaxCrisisReminderPeriod:dtSecond, AvpLastReminder:dtDateAndTime, AvpStarted:ptBoolean):ptBoolean}}{used to initialize the current object as a new instance of the ctState type.}
\adddoublerow{ctVictim}{Used to model victim of a crisis}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtVictimID}}{the victim unique identification information.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtVictimID):ptBoolean}}{used to initialize the current object as a new instance of the ctVictim type.}
\adddoubletwocolumnrow{operation}{\msrcode{isSentToCoordinator(AactCoordinator:actCoordinator):ptBoolean}}{used to provide a given coordinator with current victim information.}
\adddoubletwocolumnrow{operation}{\msrcode{isSentToHospital(AactHospital:actHospital):ptBoolean}}{used to provide a given hospital with current victim information.}
\end{datadictionary}
