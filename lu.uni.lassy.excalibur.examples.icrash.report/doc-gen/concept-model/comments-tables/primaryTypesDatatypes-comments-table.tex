...
\adddoublerow{dtHospitalID}{A string used to identify hospitals.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid hospitals identifiers.}
\adddoublerow{dtInjuryID}{A string used to identify injury.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid injury identifiers.}
...
\adddoublerow{dtVictimID}{A string used to identify victim.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid victim identifiers.}
\end{datadictionary}
...
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which litteral belongs to the enumeration.}
\adddoublerow{etInjuryKind}{this type is used to indicate the kind of injury victims gets in a crisis.}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which litteral belongs to the enumeration.}
\end{datadictionary}
