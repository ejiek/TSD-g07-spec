...
\input{doc/general-description/general-description-Stakeholders-Hospital.tex}

\subsection{Corrupters}
\input{doc/general-description/general-description-Stakeholders-Corrupter.tex}
...
\begin{itemize}
  ...
  \item \msrcode{actHospital}: for the Hospitals stakeholders.
  \item \msrcode{actCorrupterr}: for the Corrupters stakeholders.
